...
class __TwigTemplate_97d16a5be4d8336aa926a57bc0e27373ff33779155d49cc3614b1aa327729d2d extends Template
{
    private $source;
    private $macros = [];
...
<div class=\"container pb-5 \">
    <div class=\"bg-light mt-5 d-flex justify-content-center\">
        ...
        echo "\" method=\"post\">
            <div>
                <input placeholder=\"labonneallocation@outlook.com\" type=\"text\" name=\"_username\" class=\"m-3\" required>
            </div>
            <div>
...
";
    ...
    {
        return array (  114 => 27,  108 => 21,  94 => 10,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
<div class=\"container pb-5 \">
    ...
    {#  {{ form_widget(formConnexion.email, {'attr': {'placeholder': 'Votre email', 'name': '_username','class': 'm-3', 'style': 'height: 50px;'}}) }}
        {{ form_widget(formConnexion.password, {'attr': {'placeholder': 'Mot de passe', 'name': '_password', 'class': 'm-3', 'style': 'height: 50px;'}}) }}
        #}
</div>
